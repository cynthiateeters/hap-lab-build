...
node -e "
  const fs = require('fs');
  const data = JSON.parse(fs.readFileSync('data/your-data-file.json', 'utf8'));
...
```
Test the interactive demo on station3.html:
1. Validate data file structure
2. Test default state (no parameters)
3. Test valid input
4. Test invalid input
5. Check for console errors
6. Document results in reports/test-results.md
```
...
**Source**: HAP testing checklist + Chrome DevTools MCP testing plan
