...
**Good pattern** (whitelist validation from project JavaScript):
...
**XSS-safe pattern** (from project JavaScript):
...
**Example from project JavaScript** (native JSON parsing):
...
**Source**: HAP JavaScript Security Audit + project JavaScript security patterns
